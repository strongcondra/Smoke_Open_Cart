...
class ControllerExtensionThemeThemeDefault extends Controller {
	...
	public function index() {
		...
		$data['entry_slider_category'] = $this->language->get('entry_slider_category');
		$data['entry_common_slider'] = $this->language->get('entry_common_slider');
		...
		if (isset($this->error['slider_category'])) {
			$data['error_slider_category'] = $this->error['slider_category'];
		} else {
			$data['error_slider_category'] = '';
		}
		
		if (isset($this->error['common_slider'])) {
			$data['error_common_slider'] = $this->error['common_slider'];
		} else {
			$data['error_common_slider'] = '';
		}
		...
		if (isset($this->request->post['theme_default_slider_category_width'])) {
			$data['theme_default_slider_category_width'] = $this->request->post['theme_default_slider_category_width'];
		} elseif (isset($setting_info['theme_default_slider_category_width'])) {
			$data['theme_default_slider_category_width'] = $this->config->get('theme_default_slider_category_width');
		} else {
			$data['theme_default_slider_category_width'] = 1920;		
		}
		
		if (isset($this->request->post['theme_default_slider_category_height'])) {
			$data['theme_default_slider_category_height'] = $this->request->post['theme_default_slider_category_height'];
		} elseif (isset($setting_info['theme_default_slider_category_height'])) {
			$data['theme_default_slider_category_height'] = $this->config->get('theme_default_slider_category_height');
		} else {
			$data['theme_default_slider_category_height'] = 200;
		}
		
		if (isset($this->request->post['theme_default_common_slider_width'])) {
			$data['theme_default_common_slider_width'] = $this->request->post['theme_default_common_slider_width'];
		} elseif (isset($setting_info['theme_default_common_slider_width'])) {
			$data['theme_default_common_slider_width'] = $this->config->get('theme_default_common_slider_width');
		} else {
			$data['theme_default_common_slider_width'] = 1920;		
		}
		
		if (isset($this->request->post['theme_default_common_slider_height'])) {
			$data['theme_default_common_slider_height'] = $this->request->post['theme_default_common_slider_height'];
		} elseif (isset($setting_info['theme_default_common_slider_height'])) {
			$data['theme_default_common_slider_height'] = $this->config->get('theme_default_common_slider_height');
		} else {
			$data['theme_default_common_slider_height'] = 200;
		}
	...
	protected function validate() {
		...
		if (!$this->request->post['theme_default_slider_category_width'] || !$this->request->post['theme_default_slider_category_height']) {
			$this->error['slider_category'] = $this->language->get('error_slider_category');
		}
		
		if (!$this->request->post['theme_default_common_slider_width'] || !$this->request->post['theme_default_common_slider_height']) {
			$this->error['common_slider'] = $this->language->get('error_common_slider');
		}
