<?php
	...
	if ($results) {
		...
		if (!isset($_GET['cron'])) {
			...
			$workbook->send('sales_report_'.date($this->config->get('advso' . $user_id . '_hour_format') == '24' ? "Y-m-d_H-i-s" : "Y-m-d_h-i-s-A").'.xls');
		...
		in_array('tr_tax_name', $advso_settings_tr_columns) ? $worksheet->setColumn($j,$j++,20) : '';
		in_array('tr_tax_rate', $advso_settings_tr_columns) ? $worksheet->setColumn($j,$j++,10) : '';
		in_array('tr_tax_orders', $advso_settings_tr_columns) ? $worksheet->setColumn($j,$j++,10) : '';
		in_array('tr_tax_total', $advso_settings_tr_columns) ? $worksheet->setColumn($j,$j++,13) : '';
		} elseif ($filter_report == 'coupon') {
		...
		in_array('tr_tax_name', $advso_settings_tr_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_tax_title'), $boxFormatText) : '';
		in_array('tr_tax_rate', $advso_settings_tr_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_tax_rate'), $boxFormatNumber) : '';
		in_array('tr_tax_orders', $advso_settings_tr_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_orders'), $boxFormatNumber) : '';
		in_array('tr_tax_total', $advso_settings_tr_columns) ? $worksheet->writeString($i, $j++, $this->language->get('column_tax_total'), $boxFormatNumber) : '';
		...
		$j = 0;
			...
			$excelRow = $i+1;
				...
				in_array('tr_tax_name', $advso_settings_tr_columns) ? $worksheet->write($i, $j++, $result['tax_title'], $textFormat) : '';
				in_array('tr_tax_rate', $advso_settings_tr_columns) ? $worksheet->write($i, $j++, $result['tax_rate'] != NULL ? $result['tax_rate'] : '', $priceFormat) : '';
				in_array('tr_tax_orders', $advso_settings_tr_columns) ? $worksheet->write($i, $j++, $result['orders']) : '';
				in_array('tr_tax_total', $advso_settings_tr_columns) ? $worksheet->write($i, $j++, $result['total_tax_raw'], $priceFormat) : '';
