			...
			if ($order_info) {
				...
				if ($store_info) {
					...
					if (isset($store_info['config_logo']) && is_file(DIR_IMAGE . $store_info['config_logo'])) {
					        $store_logo = $this->model_tool_image->resize($store_info['config_logo'], 250, 67);
					} else {
						$store_logo = $this->model_tool_image->resize('no_image.png', 250, 67);
					}
				} else {
					...
					if ($this->config->get('config_logo') && is_file(DIR_IMAGE . $this->config->get('config_logo'))) {
						$store_logo = $this->model_tool_image->resize($this->config->get('config_logo'), 250, 67);
					} else {
						$store_logo = $this->model_tool_image->resize('no_image.png', 250, 67);
					}
				}
