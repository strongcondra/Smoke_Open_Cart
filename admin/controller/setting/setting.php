...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		/* Custom */
		$data['entry_about_store'] = $this->language->get('entry_about_store');
		$data['entry_store_warning'] = $this->language->get('entry_store_warning');
		$data['entry_common_banner'] = $this->language->get('entry_common_banner');
		$data['entry_footer_logo'] = $this->language->get('entry_footer_logo');
		$data['entry_toll_free'] = $this->language->get('entry_toll_free');
		// Social Share
		...
		$data['help_vimeo'] = $this->language->get('help_vimeo');
		...
		$data['help_linkedin'] = $this->language->get('help_linkedin');
		$data['help_google_plus'] = $this->language->get('help_google_plus');
		$data['help_common_banner'] = $this->language->get('help_common_banner');
		...
		if (isset($this->request->post['config_toll_free'])) {
			$data['config_toll_free'] = $this->request->post['config_toll_free'];
		} else {
			$data['config_toll_free'] = $this->config->get('config_toll_free');
		}
		...
		if (isset($this->request->post['config_about_store'])) {
			$data['config_about_store'] = $this->request->post['config_about_store'];
		} else {
			$data['config_about_store'] = $this->config->get('config_about_store');
		}
		
		if (isset($this->request->post['config_store_warning'])) {
			$data['config_store_warning'] = $this->request->post['config_store_warning'];
		} else {
			$data['config_store_warning'] = $this->config->get('config_store_warning');
		}
		...
		if (isset($this->request->post['config_common_banner'])) {
			$data['config_common_banner'] = $this->request->post['config_common_banner'];
		} else {
			$data['config_common_banner'] = $this->config->get('config_common_banner');
		}

		if (isset($this->request->post['config_common_banner']) && is_file(DIR_IMAGE . $this->request->post['config_common_banner'])) {
			$data['common_banner'] = $this->model_tool_image->resize($this->request->post['config_common_banner'], 100, 100);
		} elseif ($this->config->get('config_common_banner') && is_file(DIR_IMAGE . $this->config->get('config_common_banner'))) {
			$data['common_banner'] = $this->model_tool_image->resize($this->config->get('config_common_banner'), 100, 100);
		} else {
			$data['common_banner'] = $this->model_tool_image->resize('no_image.png', 100, 100);
		}
