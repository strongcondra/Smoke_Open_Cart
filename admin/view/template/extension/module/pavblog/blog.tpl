...
<div id="content">
	...
	<div id="page-content" class="container-fluid">
		...
		<!-- <div class="toolbar"><?php include("view/template/extension/module/pavblog/toolbar.tpl"); ?></div>
		tools bar blog -->
									...
									<tr>
										...
										<td class="col-sm-10">
											<div class="input-group date" style="width:20%">
												<input type="text" name="pavblog_blog[created]" value="<?php echo $blog['created'];?>"  placeholder="YYYY-MM-DD" data-date-format="YYYY-MM-DD" id="input-pavblog-blog-created" class="form-control" />
