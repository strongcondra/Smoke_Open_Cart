					...
					<div id="tab-general" class="tab-pane">
						<table class="table">
							...
							<tr>
								...
								<tr>
								<td class="col-sm-4"><?php echo $objlang->get('text_keyword_heading');?></td>
								<td class="col-sm-8"><input style="width:20%"class="form-control"size="30" name="pavblog[keyword_heading]" value="<?php echo $general_setting['keyword_heading'];?>" /></td>
							</tr>	
							<tr>
								<td class="col-sm-4"><?php echo $objlang->get('text_meta_keyword');?></td>
								<td class="col-sm-8"><input style="width:20%"class="form-control"size="30" name="pavblog[meta_keyword]" value="<?php echo $general_setting['meta_keyword'];?>" /></td>
							</tr>	
							<tr>
								<td class="col-sm-4"><?php echo $objlang->get('text_meta_description');?></td>
								<td class="col-sm-8"><textarea type="text" style="width:20%"class="form-control" rows="6" cols="10"name="pavblog[meta_description]" value="<?php echo $general_setting['meta_description'];?>" /><?php echo $general_setting['meta_description'];?></textarea></td>
