					...
					<div class="tab-content">
						<div class="tab-pane active" id="tab-newest">
							...
							<?php foreach( $newest as $blog ) { ?>
								<li>
									<a href="<?php echo $objurl->link("extension/module/pavblog/blog","id=".$blog['blog_id']."&token=".$token);?>"><?php echo $blog['title'];?></a>
								</li>
							<?php } ?>
							</ul>
						</div>
						...
						<div class="tab-pane" id="tab-comment">
							<ul>
								...
								<li><a href="<?php echo $objurl->link("extension/module/pavblog/comment","id=".$comment['comment_id']."&token=".$token);?>"><?php echo utf8_substr($comment['comment'],0,100);?></a></li>
								<?php } ?>
							</ul>
						</div>
					</div>
