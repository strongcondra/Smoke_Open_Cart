      ...
      <div class="panel-body">
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-theme-default" class="form-horizontal">
          ...
          <fieldset>
			...
			<div class="form-group required">
              <label class="col-sm-2 control-label" for="input-slider-category-width"><?php echo $entry_common_slider; ?></label>
              <div class="col-sm-10">
                <div class="row">
                  <div class="col-sm-6">
                    <input type="text" name="theme_default_common_slider_width" value="<?php echo $theme_default_common_slider_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-slider-category-width" class="form-control" />
                  </div>
                  <div class="col-sm-6">
                    <input type="text" name="theme_default_common_slider_height" value="<?php echo $theme_default_common_slider_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
                  </div>
                </div>
                <?php if ($error_common_slider) { ?>
                <div class="text-danger"><?php echo $error_common_slider; ?></div>
                <?php } ?>
              </div>
            </div>
			<div class="form-group required">
              <label class="col-sm-2 control-label" for="input-slider-category-width"><?php echo $entry_slider_category; ?></label>
              <div class="col-sm-10">
                <div class="row">
                  <div class="col-sm-6">
                    <input type="text" name="theme_default_slider_category_width" value="<?php echo $theme_default_slider_category_width; ?>" placeholder="<?php echo $entry_width; ?>" id="input-slider-category-width" class="form-control" />
                  </div>
                  <div class="col-sm-6">
                    <input type="text" name="theme_default_slider_category_height" value="<?php echo $theme_default_slider_category_height; ?>" placeholder="<?php echo $entry_height; ?>" class="form-control" />
                  </div>
                </div>
                <?php if ($error_slider_category) { ?>
                <div class="text-danger"><?php echo $error_slider_category; ?></div>
                <?php } ?>
              </div>
            </div>
            <div class="form-group required">
