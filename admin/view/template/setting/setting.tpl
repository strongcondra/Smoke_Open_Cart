        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
			  ...
			  <div class="form-group">
				<label class="col-sm-2 control-label" for="input-toll-free"><?php echo $entry_toll_free; ?></label>
				<div class="col-sm-10">
				  <input type="text" name="config_toll_free" value="<?php echo $config_toll_free; ?>" placeholder="<?php echo $entry_toll_free; ?>" id="input-toll-free" class="form-control" />
				</div>
			  </div>
              <div class="form-group">
              ...
              <?php } ?>
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-about-store"><?php echo $entry_about_store; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_about_store" rows="5" placeholder="<?php echo $entry_about_store; ?>" id="input-about-store" class="form-control"><?php echo $config_about_store; ?></textarea>
                </div>
              </div>
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-store-warning"><?php echo $entry_store_warning; ?></label>
                <div class="col-sm-10">
                  <textarea name="config_store_warning" rows="5" placeholder="<?php echo $entry_store_warning; ?>" id="input-store-warning" class="form-control"><?php echo $config_store_warning; ?></textarea>
                </div>
              </div>
            </div>
            ...
            <div class="tab-pane" id="tab-image">
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-footer-logo"><?php echo $entry_footer_logo; ?></label>
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-common-banner"><span data-toggle="tooltip" title="<?php echo $help_common_banner; ?>"><?php echo $entry_common_banner; ?></span></label>
                <div class="col-sm-10"><a href="" id="thumb-common-banner" data-toggle="image" class="img-thumbnail"><img src="<?php echo $common_banner; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a>
                  <input type="hidden" name="config_common_banner" value="<?php echo $config_common_banner; ?>" id="input-common-banner" />
                </div>
               </div>
            </div>
			...
			<div class="tab-pane" id="tab-social">
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-facebook"><span data-toggle="tooltip" title="<?php echo $help_facebook; ?>"><?php echo $entry_facebook; ?></span></label>
                <div class="col-sm-10">
              ...
              <div class="form-group">
                <label class="col-sm-2 control-label" for="input-twitter"><span data-toggle="tooltip" title="<?php echo $help_twitter; ?>"><?php echo $entry_twitter; ?></span></label>
                <div class="col-sm-10">
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-youtube"><span data-toggle="tooltip" title="<?php echo $help_youtube; ?>"><?php echo $entry_youtube; ?></span></label>
                <div class="col-sm-10">
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-vimeo"><span data-toggle="tooltip" title="<?php echo $help_vimeo; ?>"><?php echo $entry_vimeo; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_vimeo" value="<?php echo $config_vimeo; ?>" placeholder="<?php echo $entry_vimeo; ?>" id="input-vimeo" class="form-control" />
                </div>
              </div>
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-instagram"><span data-toggle="tooltip" title="<?php echo $help_instagram; ?>"><?php echo $entry_instagram; ?></span></label>
                <div class="col-sm-10">
			  ...
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-pinterest"><span data-toggle="tooltip" title="<?php echo $help_pinterest; ?>"><?php echo $entry_pinterest; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_pinterest" value="<?php echo $config_pinterest; ?>" placeholder="<?php echo $entry_pinterest; ?>" id="input-pintrest" class="form-control" />
                </div>
              </div>
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-linkedin"><span data-toggle="tooltip" title="<?php echo $help_linkedin; ?>"><?php echo $entry_linkedin; ?></span></label>
                <div class="col-sm-10">
                  <input type="text" name="config_linkedin" value="<?php echo $config_linkedin; ?>" placeholder="<?php echo $entry_linkedin; ?>" id="input-linkedin" class="form-control" />
                </div>
              </div>
			  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-google-plus"><span data-toggle="tooltip" title="<?php echo $help_google_plus; ?>"><?php echo $entry_google_plus; ?></span></label>
                <div class="col-sm-10">
