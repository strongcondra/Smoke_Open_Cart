		...
		public function index() {  
			...
			$this->mdata = array(
				...
				if (version_compare(VERSION, '2.1.0.1') >= 0) {
				 	$config	 = $this->mparams;
					  $this->mdata['keyword_heading'] = $config->get('keyword_heading');
					  $this->mdata['meta_keyword'] = $config->get('meta_keyword');
			         $this->mdata['meta_description'] = $config->get('meta_description');
				} else {
			...
			if ($blogs) {
		    	...
		    	$data['heading_title'] = $this->language->get('heading_title');
					$this->document->setTitle( $this->mdata['keyword_heading'] );
				
				$this->document->setKeywords( $this->mdata['meta_keyword'] );
				$this->document->setDescription( $this->mdata['meta_description'] );
