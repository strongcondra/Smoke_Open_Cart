      ...
      <div class="row">
        ...
        <div class="<?php echo $class; ?>">
          ...
          <ul class="list-unstyled prod-list">
            <?php if (!$special) { ?>
            <li>
              <!--<span class="sale-text">Retail Price: <h2 class="price"><?php echo $price; ?></h2></span>-->
			  <span class="retail-text">Retail Price: <span class="retail"><?php echo $price; ?></span></span> 
            </li>
            <?php } else { ?>
             <li><span class="retail-text">Retail Price:</span> <span style="text-decoration: line-through;" class="retail"><?php echo $price; ?></span></li>
            <li>
              <span class="sale-text">Sale Price: <h2><?php echo $special; ?></h2></span>
            </li>
            <?php } ?>
            <?php if ($tax) { ?>
            ...
            <li><span>Discount:</span> <?php echo $discount['quantity']; ?><?php echo $text_discount; ?><?php echo $discount['price']; ?></li>
            <?php } ?>
            <?php } ?>
          </ul>
          <?php } ?>
...
<!--<script>var crt_uid = 'bd08430d29f4363dfbdc76762e49285f';</script> <script async defer src="//d37phj1nwbd0r1.cloudfront.net/assets/crt.min.js"></script> -->
<!-- CartRocket.com END-->
<?php echo $footer; ?>
