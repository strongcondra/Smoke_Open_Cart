...
class ControllerOnepagecheckoutPaymentdetails extends Controller {
	...
	public function index(){
		...
		if(version_compare(VERSION,'2.2.0.0','>=')){
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/onepagecheckout/payment_details.tpl')) {
				return $this->load->view($this->config->get('config_template') . '/template/onepagecheckout/payment_details.tpl', $data);
			} else {
				return $this->load->view('default/template/onepagecheckout/payment_details.tpl', $data);
			}
		}
	}
}