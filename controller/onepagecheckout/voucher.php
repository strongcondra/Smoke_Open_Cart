	...
	public function index() {
		if ($this->config->get('voucher_status')) {
			...
			if(version_compare(VERSION,'2.2.0.0','>=')){
				...
				if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/onepagecheckout/voucher.tpl')) {
					return $this->load->view($this->config->get('config_template') . '/template/onepagecheckout/voucher.tpl', $data);
				} else {
					return $this->load->view('default/template/onepagecheckout/voucher.tpl', $data);
				}
			}
		}
	}
