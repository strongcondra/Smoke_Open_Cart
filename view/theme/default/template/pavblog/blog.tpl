		...
		<div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
			...
			<div class="pav-blog">
				<div class="image">
						...
						<img class="img-responsive space-10 space-padding-r20" src="<?php echo $blog['thumb_large'];?>" alt="<?php echo $blog['title'];?>" title="<?php echo $blog['title'];?>" style='padding-right:35px' align="center"/>
					<?php } ?>
				</div>	
					<h1 style='color: #222222;font-weight: 300;font-size: 33px;line-height: 50px;align-items: center'><?php echo $heading_title; ?></h1>
			  ...
			  <?php if( $blog_show_author || $blog_show_category || $blog_show_created || $blog_show_hits || $blog_show_comment_counter ) { ?>
		            	<hr>
