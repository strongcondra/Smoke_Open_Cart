<div id="cart" class="cart-w SC-w hd-pd">
  <a data-toggle="dropdown" class="dropdown-toggle"><i class="fa fa-shopping-cart fa-4x"></i> <span id="cart-total" class="cart-totals"><?php echo $text_items; ?></span></a>
