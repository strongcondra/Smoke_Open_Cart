...
class ControllerCommonHeader extends Controller {
	public function index() {
		...
		$data['headermenuleft'] = $this->model_catalog_headermenu->getHeadermenuleft();
		$data['headermenuright'] = $this->model_catalog_headermenu->getHeadermenuright();
		...
		foreach ($categories as $category) {
			if ($category['top']) {
				...
				if ($child['image']) {
					...
					$children_data[] = array(
						'name'  => ($image) ? $image : $child['name'] . ($this->config->get('config_product_count') ? ' (' . $this->model_catalog_product->getTotalProducts($filter_data) . ')' : ''),
